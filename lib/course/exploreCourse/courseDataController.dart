...
class CourseDataController extends StatefulWidget {
  @override
  _CourseDataControllerState createState() => _CourseDataControllerState();
}

class _CourseDataControllerState extends State<CourseDataController> with SingleTickerProviderStateMixin {
